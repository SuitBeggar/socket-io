...
public class RedisCacheUtil {
	 ...
	 * @param jsonStr
	 */
	public static void putStringCacheData(String key , String data){
		shardedJedis.set(key, data);
	}
	/**
	 * 从redis缓存中取字符串类型的数据
	 * @param key
	...
	/**
	 * 往redis缓存中存放List<String>类型的数据
	 * @param List<String> data
	 */
	public static void putStringListCacheData(String key , List<String> data){
		for (String string : data) {
			shardedJedis.lpush(key, string);
		}
	}
	/**
	 * 从redis缓存中取List<String>类型的数据
	 * @param key
	 */
	public static List<String> getStringListCacheData(String key){
		return jedis.lrange("stringlists", 0, -1);
	}
	
	/**
	 * 往redis缓存中存放Set<String>类型的数据
	 * @param Set<String> data
	 */
	public static void putStringSetCacheData(String key , Set<String> data){
		for (String string : data) {
			shardedJedis.sadd(key, string);
		}
	}
	/**
	 * 往redis的Set<String>中添加一个String类型的数据
	 * @param String data
	 */
	public static void putStringSetCacheData(String key , String data){
		shardedJedis.sadd(key, data);
	}
	/**
	 * 移除redis的Set<String>中添加一个String类型的数据
	 * @param String data
	 */
	public static void removeStringSetCacheData(String key , String data){
		jedis.srem(key, data);
	}
	/**
	 * 从redis缓存中取Set<String>类型的数据
	 * @param key
	 */
	public static Set<String> getStringSetCacheData(String key){
		return jedis.smembers(key);
	}
	
	/**
	 * 往redis缓存中存放Map<String , String>类型的数据
	 * @param Set<String> data
	 */
	public static void putStringMapCacheData(String key , Map<String , String> data){
		Set<String> keySet = data.keySet();
		for (String string : keySet) {
			shardedJedis.hset(key, string, data.get(string));
		}
	}
	/**
	 * 往redis缓存中取Map<String , String>类型的数据
	 * @param key
	 */
	public static Map<String , String> getStringMapCacheData(String key){
    ...
    private static void initialPool() { 
        ...
        String host = PropertiesUtil.getPropertiesVal("redis", "redis.host");
        int port = Integer.parseInt(PropertiesUtil.getPropertiesVal("redis", "redis.port")) ;
    ...
    private static void initialShardedPool() { 
        ...
        String host = PropertiesUtil.getPropertiesVal("redis", "redis.host");
        int port = Integer.parseInt(PropertiesUtil.getPropertiesVal("redis", "redis.port")) ;
        String name = PropertiesUtil.getPropertiesVal("redis", "redis.name") ;
	...
	public static void setShardedJedis(ShardedJedis shardedJedis) {
		RedisCacheUtil.shardedJedis = shardedJedis;
	}
	...
	public static void setShardedJedisPool(ShardedJedisPool shardedJedisPool) {
		RedisCacheUtil.shardedJedisPool = shardedJedisPool;
	}
